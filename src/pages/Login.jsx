    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
      <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-xl">
        ...
        <form onSubmit={submitHandler}>
          ...
          <button
            type="submit"
            className="w-full bg-black text-white py-2 px-4 rounded-md shadow-md hover:bg-gray-800 transition duration-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-opacity-50"
          >
            Sign In
          </button>
        </form>
